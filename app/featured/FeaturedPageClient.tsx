...
export default function FeaturedPageClient() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-950">
      <section>
        <FilterHeader
          pageTitle="Featured Handloom Picks"
        ...
        <div className="px-4 py-4">
          <div className="flex gap-6 items-start">
            {showFilters && (
              ...
              >
                <SareesFilter attributes={filterAttributes} value={filters} onFilterChange={handleFilterChange} />
              </aside>
            )}
            ...
            <section className="flex-1 min-w-0">
              ...
              {loadingProducts ? <p className="mt-3 text-sm text-slate-600">Loading featured products...</p> : null}
